...
\caption{One C-GEAR allocation event. Candidate calibration never uses validation labels; repeated $k=0$ decisions trigger consolidation rather than later rank growth.}
\label{fig:method}
\end{figure}
